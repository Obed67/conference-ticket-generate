  ...
  const handleImageUpload = (file) => {
    if (file && (file.type === 'image/jpeg' || file.type === 'image/png') && file.size <= 500000) {
      ...
      reader.onload = () => {
        ...
        localStorage.setItem('image', base64Image); // Sauvegarder l'image en base64 dans localStorage
      };
      ...
      <div className="z-10 text-white flex flex-col items-center">
        ...
        {ticketInfo ? (
          <h1 className="text-4xl mb-4">
            Congrats, {ticketInfo.fullName}! {ticketInfo.email} Your ticket is ready.
          </h1>
        ) : (
          <h1 className="text-4xl mb-4">
        ...
        {!ticketInfo ? (
          ...
          <div className="w-96 mt-6">
            <TicketCard info={ticketInfo} image={image} />
          </div>
        )}
      </div>
    </div>
